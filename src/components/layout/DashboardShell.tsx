...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex h-[100dvh] w-full overflow-hidden bg-surface-0 text-surface-900">
      ...
      <Sidebar />
      <div className="relative flex h-[100dvh] w-full flex-1 flex-col overflow-hidden lg:pl-72">
        <Header />
